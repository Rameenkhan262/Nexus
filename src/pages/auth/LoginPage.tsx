          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className={`py-3 px-4 border rounded-lg flex items-center justify-center transition-colors ${
                    role === 'entrepreneur'
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-blue-600 hover:text-primary-500">
                  Forgot your password?
                </a>
              </div>
            </div>
            
            <Button className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow"
              type="submit"
              fullWidth
              isLoading={isLoading}
          ...
          <div className="mt-6">
            ...
            <div className="mt-2 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/register" className="font-medium text-blue-600 hover:text-primary-500">
                  Sign up
                </Link>
              </p>
            </div>
